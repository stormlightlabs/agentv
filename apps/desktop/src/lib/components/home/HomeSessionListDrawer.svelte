<script lang="ts">
  ...
  let { open, filteredSessions, selectedSession, onOpenChange, onSelectSession }: Props = $props();
</script>

<Drawer {open} {onOpenChange} direction="left" size="lg" aria-label="Session list drawer">
